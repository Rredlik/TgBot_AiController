...
# # from handlers.keyboards import btn_my_requests, btn_con_event, btn_new_request, kb_main_menu
...
#                                 Text(equals=btn_my_requests), state='*')
...
#                                 Text(equals=btn_new_request), state='*')
